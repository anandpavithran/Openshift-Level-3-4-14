...
Install OADP operator,Volsync Operator
...
oc get obc
oc extract --to=/home/student/DO380/labs/backup-oadp cm/backup
oc get cm/openshift-service-ca.crt -o jsonpath='{.data.service-ca\.crt}' | base64 -w0; echo #EXECUTE IN OTHER TERMINAL
oc extract --to=/home/student/DO380/labs/backup-oadp secret/backup
